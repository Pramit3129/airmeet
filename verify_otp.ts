...
const verify = async () => {
    try {
        ...
        // Since I don't have a running DB guaranteed, I will check the schema paths and indexes from the model object.
        ...
        const ttlIndex = indexes.find(idx => idx[0].expiresAt === 1 && idx[1].expireAfterSeconds === 0);
